      ...
      <section className="section">
        ...
        <div className="stats-grid">
          ...
          <Stat label="Completados"
            value={wd.completed ?? 0}
            color="#10B981" />
          <Stat label="Monto pendiente"
            value={wd.pending_amount ? `$${parseFloat(wd.pending_amount).toFixed(2)}` : '$0.00'}
            color="#EF4444" />
          <Stat label="Monto completado"
            value={wd.completed_amount ? `$${parseFloat(wd.completed_amount).toFixed(2)}` : '$0.00'}
            color="#52525B" />
        </div>
      </section>
